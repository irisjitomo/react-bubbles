...
A token is used for authentication to websites

- [ ] What steps can you take in your web apps to keep your data secure?

Make an axiosWithAuth module for users to have that authentication token

- [ ] Describe how web servers work.

they "host" your sites and apps. They retrieve code upon the request of the user.

- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

put and delete axios requests
